...
const regions = ["All", "Global", "California", "Texas", "New York", "Florida", "Arizona"];
const tournaments = ["All", "Summer Championship", "Regional Open", "State Finals"];

export function LeaderboardFilters({ filters, onFiltersChange, activeFilterCount }: LeaderboardFiltersProps) {
  ...
  const getActiveFilters = () => {
    ...
    if (filters.region && filters.region !== "All") active.push({ key: "region", label: filters.region, value: filters.region });
  ...
  const removeFilter = (key: keyof LeaderboardFilters) => {
  ...
  return (
    <div className="space-y-4">
        ...
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          ...
          <SheetContent side="bottom" className="h-[80vh]">
            <SheetHeader>
              ...
              <SheetDescription>
                Filter the player rankings by category, gender, age group, region, and tournament to find specific players.
              </SheetDescription>
            </SheetHeader>
            <FilterContent 
              filters={filters} 
      ...
      {/* Desktop Filter Chips - REMOVED: Using toggle filters below instead */}
          ...
          {getActiveFilters().map((filter, index) => (
            ...
            >
              ...
              <Button
                ...
                onClick={() => removeFilter(filter.key as keyof LeaderboardFilters)}
              >
                <X className="w-2 h-2" />
              </Button>
            </Badge>
...
function FilterContent({ 
  ...
  filters: LeaderboardFilters; 
  updateFilter: (key: keyof LeaderboardFilters, value: string) => void;
